...
public class Ex1 {
   /* public static void main(String[] args) {
       ...
       Bolseiro bls = new Bolseiro ("Igor Santos", 8976543, new DateYMD(11, 5, 1985), pl, 900);
       bls.setBolsa(1050);
    ...
    public static void main(String[] args) {
        DateYMD data = new DateYMD(1,12,1234);
        Pessoa al = new Aluno("Joao", 1234567, data);
        System.out.println(al.getdataNasc());
